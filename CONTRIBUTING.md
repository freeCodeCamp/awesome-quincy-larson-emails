...
├── emails.xml         # Weekly emails in RSS form
├── LICENSE
...
The flow of information that these files are run in is `README.md > convert_readme.py > emails.json > convert_json.py > emails.xml`.
